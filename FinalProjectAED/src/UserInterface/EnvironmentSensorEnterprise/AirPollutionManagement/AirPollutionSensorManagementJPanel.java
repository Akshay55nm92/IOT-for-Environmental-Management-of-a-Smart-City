 ...
 * @author Akshay
 */
public class AirPollutionSensorManagementJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form AirPollutionSensorManagementJPanel
     */
    public AirPollutionSensorManagementJPanel(JPanel userProcessContainer, UserAccount account, EnvironmentSensorOrganization organization, Enterprise enterprise, EcoSystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Air Pollution Sensor Management");
    ...
    private void SendRequestjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SendRequestjButtonActionPerformed
        ...
        SendRequestToAirPollutionSolutionDepartment sendRequestToAirPollutionSolutionDepartment;
        try {
            sendRequestToAirPollutionSolutionDepartment = new SendRequestToAirPollutionSolutionDepartment(userProcessContainer, account, business, enterprise.getOrganizationDirectory());
            ...
            Logger.getLogger(AirPollutionSensorManagementJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
